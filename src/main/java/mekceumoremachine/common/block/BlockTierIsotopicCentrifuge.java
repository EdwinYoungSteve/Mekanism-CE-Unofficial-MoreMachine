...
public class BlockTierIsotopicCentrifuge extends BlockTierMachine {

    public BlockTierIsotopicCentrifuge() {
        super();
    }
    ...
    public IBlockState AddActualState(@NotNull IBlockState state, IBlockAccess worldIn, BlockPos pos, TileEntity tile) {
        if (tile instanceof TileEntityTierIsotopicCentrifuge tiers) {
            if (tiers.tier != null) {
    ...
    public TileEntity getTileEntity() {
        return new TileEntityTierIsotopicCentrifuge();
    }

    @Override
    public Block getMachineBlock() {
        return MEKCeuMoreMachineBlocks.TierIsotopicCentrifuge;
    }
