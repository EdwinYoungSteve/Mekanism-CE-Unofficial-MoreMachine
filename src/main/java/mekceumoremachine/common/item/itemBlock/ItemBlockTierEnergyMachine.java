...
public abstract class ItemBlockTierEnergyMachine extends ItemBlockTierMachine implements IEnergizedItem, ISpecialElectricItem, IEnergyContainerItem {

    public ItemBlockTierEnergyMachine(Block block, String tierName) {
    ...
    public double getMaxEnergy(ItemStack itemStack) {
        ...
        double storage = getMachineStorage() * MachineTier.values()[getBaseTier(itemStack).ordinal()].processes;
