...
public class RenderTierIsotopicCentrifuge extends TileEntitySpecialRenderer<TileEntityTierIsotopicCentrifuge> {

    public static final RenderTierIsotopicCentrifuge INSTANCE = new RenderTierIsotopicCentrifuge();
    ...
    @Override
    public void render(TileEntityTierIsotopicCentrifuge tileEntity, double x, double y, double z, float partialTick, int destroyStage, float alpha) {
        if (tileEntity.outputTank.getStored() > 0) {
            ...
            MekanismRenderer.DisplayInteger[] displayList = getListAndRender(tileEntity.outputTank.getGas());
        ...
        bindTexture(MekanismUtils.getResource(MEKCeuMoreMachine.MODID, MekanismUtils.ResourceType.RENDER, "IsotopicCentrifuge_" + tileEntity.tier.getBaseTier().getSimpleName() + ".png"));
        model.renderTier(0.0625F);
        bindTexture(MekanismUtils.getResource(MEKCeuMoreMachine.MODID, MekanismUtils.ResourceType.RENDER, "IsotopicCentrifuge.png"));
    ...
    private MekanismRenderer.DisplayInteger[] getListAndRender(GasStack gasStack) {
        ...
        for (int i = 0; i < stages; i++) {
            ...
            toReturn.minY = 0.9375 + .01;
            ;  //prevent z fighting at low fuel levels
