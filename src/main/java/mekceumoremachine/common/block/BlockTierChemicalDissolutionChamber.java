...
import mekceumoremachine.common.block.states.BlockStateTierChemicalDissolutionChamber;
...
public abstract class BlockTierChemicalDissolutionChamber extends BlockMekanismContainer {


    public BlockTierChemicalDissolutionChamber() {
        super(Material.IRON);
        setHardness(3.5F);
        setResistance(16F);
    ...
    public static BlockTierChemicalDissolutionChamber getBlockMachine(TierChemicalDissolutionChamberMachineBlock block) {
        return new BlockTierChemicalDissolutionChamber() {
            @Override
            public TierChemicalDissolutionChamberMachineBlock getMachineBlock() {
                return block;
            }
        };
    }

    public abstract TierChemicalDissolutionChamberMachineBlock getMachineBlock();

    @Nonnull
    @Override
    public BlockStateContainer createBlockState() {
        return new BlockStateTierChemicalDissolutionChamber(this, getTypeProperty());
    }
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entityplayer, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
        return MEKCeuMoreMachineUtils.onBlockActivated(this, 10, world, pos, state, entityplayer, hand, side, hitX, hitY, hitZ);
    }
