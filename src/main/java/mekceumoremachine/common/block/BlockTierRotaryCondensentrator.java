...
public class BlockTierRotaryCondensentrator extends BlockTierMachine {

    public BlockTierRotaryCondensentrator() {
        super();
    }

    @Override
    public IBlockState AddActualState(@NotNull IBlockState state, IBlockAccess worldIn, BlockPos pos, TileEntity tile) {
        if (tile instanceof TileEntityTierRotaryCondensentrator tiers) {
            if (tiers.tier != null) {
    ...
    public TileEntity getTileEntity() {
        return new TileEntityTierRotaryCondensentrator();
    }


    @Override
    public Block getMachineBlock() {
        return MEKCeuMoreMachineBlocks.TierRotaryCondensentrator;
    }
}
