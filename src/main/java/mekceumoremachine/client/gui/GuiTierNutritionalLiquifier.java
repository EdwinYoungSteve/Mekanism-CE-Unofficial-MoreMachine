...
public class GuiTierNutritionalLiquifier extends GuiMekanismTile<TileEntityTierNutritionalLiquifier> implements IJeiFactoryRecipe {
    ...
    public List<String> getRecipe() {
        return Collections.singletonList(RecipeHandler.Recipe.NUTRITIONAL_LIQUIFIER.getJEICategory());
    }
