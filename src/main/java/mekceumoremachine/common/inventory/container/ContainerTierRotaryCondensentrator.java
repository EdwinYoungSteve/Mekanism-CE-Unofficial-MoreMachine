...
public class ContainerTierRotaryCondensentrator extends ContainerMekanism<TileEntityTierRotaryCondensentrator> {
    ...
    protected void addSlots() {
        ...
        addSlotToContainer(new SlotEnergy.SlotDischarge(tileEntity, 4, 155, 5));
    }
}
