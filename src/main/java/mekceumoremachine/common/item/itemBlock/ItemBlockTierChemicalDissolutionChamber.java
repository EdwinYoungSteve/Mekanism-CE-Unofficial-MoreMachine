...
public class ItemBlockTierChemicalDissolutionChamber extends ItemBlock implements IEnergizedItem, ISpecialElectricItem, IEnergyContainerItem, ISustainedInventory, ISecurityItem , IItemTipName {
    ...
    public ItemBlockTierChemicalDissolutionChamber(Block block) {
        super(block);
        metaBlock = block;
        setHasSubtypes(true);
        setNoRepair();
    ...
    public String getTranslationKey(ItemStack itemstack) {
        if (MachineType.get(itemstack) != null) {
            ...
            return "tile.TierChemicalDissolutionChamber." + tier.getSimpleName() + ".name";
        }
        return "null";
    }
    ...
    public String getItemStackDisplayName(@Nonnull ItemStack itemstack) {
        if (MachineType.get(itemstack) != null) {
            MachineType type = MachineType.get(itemstack);
            BaseTier tier = type.tier.getBaseTier();
            return tier.getColor() + LangUtils.localize("tile.TierChemicalDissolutionChamber." + tier.getSimpleName() + ".name");
        }
    ...
    public double getMachineStorage() {
        return BlockStateMachine.MachineType.CHEMICAL_DISSOLUTION_CHAMBER.getStorage();
    }
    ...
    public String getItemName() {
        return "TierChemicalDissolutionChamber";
    }
}
