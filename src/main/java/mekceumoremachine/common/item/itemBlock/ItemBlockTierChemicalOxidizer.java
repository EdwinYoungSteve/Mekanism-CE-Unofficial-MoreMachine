...
public class ItemBlockTierChemicalOxidizer extends ItemBlock implements IEnergizedItem, ISpecialElectricItem, IEnergyContainerItem, ISustainedInventory, ISecurityItem , IItemTipName {
