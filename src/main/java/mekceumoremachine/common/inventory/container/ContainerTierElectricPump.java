...
public class ContainerTierElectricPump extends ContainerMekanism<TileEntityTierElectricPump> {
    ...
    protected void addSlots() {
        ...
        addSlotToContainer(new SlotEnergy.SlotDischarge(tileEntity, 2, 143, 35));
    }
}
