...
import mekceumoremachine.common.block.BlockTierChemicalOxidizer;
...
public class BlockStateTierChemicalOxidizer extends ExtendedBlockState {


    public BlockStateTierChemicalOxidizer(BlockTierChemicalOxidizer block, PropertyEnum<?> typeProperty) {
    ...
    public enum TierChemicalOxidizerMachineBlock {
        MACHINE_BLOCK;
        ...
        public Block getBlock() {
            return switch (this) {
                case MACHINE_BLOCK -> MEKCeuMoreMachineBlocks.TierChemicalOxidizer;
            };
        }
    }

    public enum MachineType implements IStringSerializable, IBlockType {
        TIER_CHEMICAL_OXIDIZER_BASIC(0, TileEntityTierChemicalOxidizerBasic::new, Plane.HORIZONTAL,MachineTier.BASIC),
        TIER_CHEMICAL_OXIDIZER_ADVANCED(1, TileEntityTierChemicalOxidizerAdvanced::new, Plane.HORIZONTAL,MachineTier.ADVANCED),
        TIER_CHEMICAL_OXIDIZER_ELITE(2, TileEntityTierChemicalOxidizerElite::new, Plane.HORIZONTAL,MachineTier.ELITE),
        TIER_CHEMICAL_OXIDIZER_ULTIMATE(3, TileEntityTierChemicalOxidizerUltimate::new, Plane.HORIZONTAL,MachineTier.ULTIMATE);

        private static final Map<TierChemicalOxidizerMachineBlock, Int2ReferenceMap<MachineType>> VALID_METAS = new EnumMap<>(TierChemicalOxidizerMachineBlock.class);

        static {
            Arrays.stream(values()).forEach(MachineType::registerType);
        }

        public final TierChemicalOxidizerMachineBlock typeBlock = TierChemicalOxidizerMachineBlock.MACHINE_BLOCK;
        public int meta;
        public final String blockName = "TierChemicalOxidizer";
        ...
        public static MachineType get(IBlockState state) {
            if (state.getBlock() instanceof BlockTierChemicalOxidizer machine) {
        ...
        public static MachineType get(Block block, int meta) {
            if (block instanceof BlockTierChemicalOxidizer machine) {
                return get(machine.getMachineBlock(), meta);
            }
            return null;
        }

        public static MachineType get(TierChemicalOxidizerMachineBlock block, int meta) {
    ...
    public static class tierChemicalOxidizerBlockStateMapper extends StateMapperBase {
        @Nonnull
        @Override
        protected ModelResourceLocation getModelResourceLocation(@Nonnull IBlockState state) {
            BlockTierChemicalOxidizer block = (BlockTierChemicalOxidizer) state.getBlock();
