...
public class ContainerTierAmbientAccumulator extends ContainerMekanism<TileEntityTierAmbientAccumulator> {
    ...
    protected void addSlots() {
        ...
        addSlotToContainer(new SlotEnergy.SlotDischarge(tileEntity, 1, 136, 67));
    }
}