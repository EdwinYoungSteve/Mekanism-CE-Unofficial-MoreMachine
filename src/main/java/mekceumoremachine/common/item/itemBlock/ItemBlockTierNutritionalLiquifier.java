...
public class ItemBlockTierNutritionalLiquifier extends ItemBlock implements IEnergizedItem, ISpecialElectricItem, IEnergyContainerItem, ISustainedInventory, ISecurityItem , IItemTipName {


    public Block metaBlock;

    public ItemBlockTierNutritionalLiquifier(Block block) {
        super(block);
        metaBlock = block;
        setHasSubtypes(true);
        setNoRepair();
    ...
    public String getTranslationKey(ItemStack itemstack) {
        if (MachineType.get(itemstack) != null) {
            ...
            return "tile.TierNutritionalLiquifier." + tier.getSimpleName() + ".name";
        }
        return "null";
    }
    ...
    public String getItemStackDisplayName(@Nonnull ItemStack itemstack) {
        if (MachineType.get(itemstack) != null) {
            MachineType type = MachineType.get(itemstack);
            BaseTier tier = type.tier.getBaseTier();
            return tier.getColor() + LangUtils.localize("tile.TierNutritionalLiquifier." + tier.getSimpleName() + ".name");
        }
    ...
    public String getItemName() {
        return "TierNutritionalLiquifier";
    }
}
