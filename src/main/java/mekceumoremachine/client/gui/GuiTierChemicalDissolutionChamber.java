...
import mekceumoremachine.common.inventory.container.ContainerTierChemicalDissolutionChamber;
...
public class GuiTierChemicalDissolutionChamber extends GuiMekanismTile<TileEntityTierChemicalDissolutionChamber> implements IJeiFactoryRecipe {

    private GuiButton oldSortingButton;

    public GuiTierChemicalDissolutionChamber(InventoryPlayer inventory, TileEntityTierChemicalDissolutionChamber tile) {
        super(tile, new ContainerTierChemicalDissolutionChamber(inventory, tile));
        ...
        //额外插槽
        addGuiElement(new GuiExtraSlot(this, resource, 6, 68, tileEntity).with(GuiSlot.SlotOverlay.MINUS));
        //额外气体显示储罐
        addGuiElement(new GuiGasGauge(() -> tile.injectTank, GuiGauge.Type.SMALL, this, resource, 6, 34).withColor(GuiGauge.TypeColor.ORANGE));
    ...
    public List<String> getRecipe() {
        return Collections.singletonList(RecipeHandler.Recipe.CHEMICAL_DISSOLUTION_CHAMBER.getJEICategory());
    }
