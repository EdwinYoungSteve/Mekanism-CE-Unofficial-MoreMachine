...
public class BlockTierElectrolyticSeparator extends BlockTierMachine {

    public BlockTierElectrolyticSeparator() {
        super();
    }

    @Override
    public IBlockState AddActualState(@NotNull IBlockState state, IBlockAccess worldIn, BlockPos pos, TileEntity tile) {
        if (tile instanceof TileEntityTierElectrolyticSeparator tiers) {
            if (tiers.tier != null) {
    ...
    public TileEntity getTileEntity() {
        return new TileEntityTierElectrolyticSeparator();
    }

    @Override
    public Block getMachineBlock() {
        return MEKCeuMoreMachineBlocks.TierElectrolyticSeparator;
    }
}
