...
public class BlockTierAmbientAccumulator extends BlockTierMachine {

    public BlockTierAmbientAccumulator() {
        super();
    }

    @Override
    public IBlockState AddActualState(@NotNull IBlockState state, IBlockAccess worldIn, BlockPos pos, TileEntity tile) {
        if (tile instanceof TileEntityTierAmbientAccumulator tiers) {
            if (tiers.tier != null) {
    ...
    public TileEntity getTileEntity() {
        return new TileEntityTierAmbientAccumulator();
    }

    @Override
    public Block getMachineBlock() {
        return MEKCeuMoreMachineBlocks.TierAmbientAccumulator;
    }
}
