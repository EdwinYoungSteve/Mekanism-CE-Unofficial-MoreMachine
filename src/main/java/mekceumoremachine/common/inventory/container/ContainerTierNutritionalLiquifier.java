...
public class ContainerTierNutritionalLiquifier extends ContainerMekanism<TileEntityTierNutritionalLiquifier> {
    ...
    private boolean isInputItem(ItemStack itemstack) {
        for (ItemStackInput input : RecipeHandler.Recipe.NUTRITIONAL_LIQUIFIER.get().keySet()) {
