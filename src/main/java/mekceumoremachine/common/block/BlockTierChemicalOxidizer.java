...
public abstract class BlockTierChemicalOxidizer extends BlockMekanismContainer {


    public BlockTierChemicalOxidizer() {
        super(Material.IRON);
        setHardness(3.5F);
        setResistance(16F);
    ...
    public static BlockTierChemicalOxidizer getBlockMachine(TierChemicalOxidizerMachineBlock block) {
        return new BlockTierChemicalOxidizer() {
            @Override
            public TierChemicalOxidizerMachineBlock getMachineBlock() {
                return block;
            }
        };
    }

    public abstract TierChemicalOxidizerMachineBlock getMachineBlock();

    @Nonnull
    @Override
    public BlockStateContainer createBlockState() {
        return new BlockStateTierChemicalOxidizer(this, getTypeProperty());
    }
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entityplayer, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
        return MEKCeuMoreMachineUtils.onBlockActivated(this, 12, world, pos, state, entityplayer, hand, side, hitX, hitY, hitZ);
    }
