...
public class ContainerTierIsotopicCentrifuge extends ContainerMekanism<TileEntityTierIsotopicCentrifuge> {
    ...
    protected void addSlots() {
        ...
        addSlotToContainer(new SlotEnergy.SlotDischarge(tileEntity, 2, 155, 14));
    }
}
